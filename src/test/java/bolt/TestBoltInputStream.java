...
public class TestBoltInputStream extends BoltTestBase {

	@Test
	public void test1()throws Exception{
		BoltInputStream is=new BoltInputStream(null);
	...
	public void testLargeDataSetTwoThreads()throws Exception{
		final BoltInputStream is=new BoltInputStream(null);
		is.setBlocking(false);
		int n=100;
	...
	protected String readAll(BoltInputStream is, int bufsize, boolean sendNoMoreData)throws Exception{
