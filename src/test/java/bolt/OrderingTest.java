 ...
 */
public class OrderingTest extends BoltTestBase
{

    /*
    Combinations:
    (In|Out of) order sending.
    (Unordered|Ordered) packets.
    (With|No) packet loss.
    TODO investigate if all combinations can be tested with random data.
     */
